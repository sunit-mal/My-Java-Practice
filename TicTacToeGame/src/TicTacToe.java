...
class TicTacToe extends JFrame implements ItemListener, ActionListener {
  ...
  TicTacToe() {
    ...
    type = true;
    set = true;
    ic1 = new ImageIcon(imageDirectory + "ic1.jpg");
    ic2 = new ImageIcon(imageDirectory + "ic2.jpg");
    ic11 = new ImageIcon(imageDirectory + "ic11.jpg");
    ic22 = new ImageIcon(imageDirectory + "ic22.jpg");
